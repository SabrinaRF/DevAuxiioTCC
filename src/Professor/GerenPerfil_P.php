<?php
	...
	$sql = "SELECT usuarios.nome, usuarios.user, usuarios.email, usuarios.cpf, usuarios.imgnome, professor.area_atuante1, professor.area_atuante2, professor.area_atuante3,professor.vagas FROM `usuarios`, `professor` WHERE usuarios.idusuarios = professor.idusuarios AND usuarios.idusuarios = \"$id\"";
	...
	<header >
		<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">		
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				...
				<li class="nav-item ">
					<a class="nav-link" href="../Professor/PaginaInicial_Professor.php">Início </a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item dropdown">
					...
					<li class="navbar-nav nav-item dropdown active">
					...
					echo '<div class="modal " id="modalupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<form enctype="multipart/form-data" action="perfil_up_P.php" method="post"> 
