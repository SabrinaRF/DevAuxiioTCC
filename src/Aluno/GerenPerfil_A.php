<?php
	...
	$sql = "SELECT usuarios.nome, usuarios.user, usuarios.email, usuarios.cpf, usuarios.imgnome, aluno.matricula,aluno.curso FROM `usuarios`, `aluno` WHERE usuarios.idusuarios = aluno.idusuarios AND usuarios.idusuarios = \"$id\"";
	...
	<header >
		<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">		
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				...
				<li class="nav-item">
					<a class="nav-link" href="PaginaInicial_Aluno.php">Início <span class="sr-only">(Página atual)</span></a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item dropdown">
					...
					<a class="nav-link dropdown-toggle active" href="#" id="dropConf" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<div class="dropdown-menu" aria-labelledby="dropConf">
								<a class="dropdown-item" href="GerenPerfil_A.php">Perfil do usuário</a>
								<div class="dropdown-divider"></div>
			...
			<div class="row pb-5 ">				
				<div class="col-12 mt-4 text-center">
					<button type="button" class="btn btn-light btn-sm bg-transparent" data-toggle="modal" data-target="#modalupload">
						<a>
							<img src="arquivos_img/<?php echo $dados["imgnome"];?>" alt="Editar" class="rounded-circle"  width="150" height="150">
						</a>
					</button>
					...
					echo '<div class="modal " id="modalupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<form enctype="multipart/form-data" action="perfil_up_A.php" method="post"> 
				...
				<div class="col-11 mt-5 pl-5 ml-5">
							...
							echo '<div class="modal " id="modalnome" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<form action="perfil_A.php" method="post">     
											<div class="mb-3">
					...
					<div class="row">
						<div class="col-9">
							<p>Matrícula: <?php echo $dados["matricula"];?></p>
						<hr>
						</div>
						<div class="col-2 text-right">
							<p>
								<button type="button" class="btn btn-light btn-sm bg-transparent" data-toggle="modal" data-target="#modalmatricula">
									<a>
										<img src="../imagens/editar25.png" alt="Editar" class="rounded"  width="24" height="24">
									</a>
								</button>
						...
						<?php //////////                PERFIL MATRICULA	                      /////////////

							echo'<meta charset="UTF-8">';

								//     Modal Editar
							echo '<div class="modal " id="modalmatricula" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog " role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">Edição de perfil</h5>
										...
										<div class="modal-body">
											...
											<div class="mb-3">
												...
												<input type="number" class="form-control" id="matricula" name="matricula"  value="'.$dados['matricula'].'"required>								
											</div>																				
										</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                    ...
                    <div class="row">
						...
						<div class="col-2 text-right">
							<p>
								<button type="button" class="btn btn-light btn-sm bg-transparent" data-toggle="modal" data-target="#modalcurso">
									<a>
										<img src="../imagens/editar25.png" alt="Editar" class="rounded"  width="24" height="24">
									</a>
								</button>
						...
						<?php //////////                PERFIL CURSO                 ////////////
							...
							echo'<meta charset="UTF-8">';
								...
								//     Modal Editar
							echo '<div class="modal " id="modalcurso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog " role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="exampleModalLabel">Edição de perfil</h5>
										...
										<div class="modal-body">
											...
											<div class="mb-3">
												...
												<input type="text" class="form-control" id="curso" name="curso"  value="'.$dados['curso'].'"required>								
											</div>																				
										</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
