...
<body>
	...
	<div class="container " id="container-corpo">
        <div class="col-md-9 order-md-1 bg-light border border-secondary pb-4" style="border-radius:10px;">
        <br>
        <form enctype="multipart/form-data" action="upload/editar_up.php" method="post">
            <h1 class="h2">
            ...
            <!-------------------------------------------------------------------------------------------------------------->
                            ...
                            <input type="hidden" value="<?php echo $dados['iddocumento'];?>" name="id">  
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="arq" name="nome_arq"  value="<?php echo $dados['nome'];?>"required>
